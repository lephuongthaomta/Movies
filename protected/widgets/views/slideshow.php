                    ...
                    <div class="banner">
                        <ul>
                            ...
                            <li data-transition="fade" data-slotamount="7" class="slide" data-slide='Rush.'>
                                <iframe width="1400" height="617" src="https://www.youtube.com/embed/SlsXP0bFlZ4" frameborder="0" allowfullscreen></iframe>
<!--                                 <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/slides/m1.jpg">
...
Create trip film.'>
                                <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/bg-video.jpg">
                                 <div class="caption slide__video" data-x="0" data-y="0" data-autoplay='true'>
                                   <video class="media-element"  autoplay="autoplay" preload='none' loop="loop" muted="" src="video/53170154.mp4" >
                                        <source type="video/webm" src="<?php echo Yii::app()->request->baseUrl; ?>/video/53170154.webm">
                                        <source type="video/mp4" src="<?php echo Yii::app()->request->baseUrl; ?>/video/53170154.mp4">
                                        <source type="video/ogg" src="<?php echo Yii::app()->request->baseUrl; ?>/video/53170154.ogv">
...
Start doing.'>
                                <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/slides/next-slide.jpg">
