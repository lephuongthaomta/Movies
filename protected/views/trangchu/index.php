            <div class="movie-beta__item ">
                        <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-sample1.jpg">
                     ...
                     <div class="movie-beta__item second--item">
                         <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-sample2.jpg">
                         <span class="best-rate">5.0</span>
                     ...
                     <div class="movie-beta__item third--item">
                         <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-sample3.jpg">
                         <span class="best-rate">5.0</span>
                     ...
                     <div class="movie-beta__item hidden-xs">
                         <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-sample4.jpg">
                         <span class="best-rate">5.0</span>
                     ...
                     <div class="movie-beta__item hidden-xs hidden-sm">
                         <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-sample5.jpg">
                         <span class="best-rate">5.0</span>
                     ...
                     <div class="movie-beta__item hidden-xs hidden-sm">
                         <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-sample6.jpg">
                         <span class="best-rate">5.0</span>
                        ...
                        <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--left">
                                <div class="movie__<?php echo Yii::app()->request->baseUrl; ?>/images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                        <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-time8.jpg">
                                    </a>
                                </div>
                                ...
                                <div class="movie__info">
                                    ...
                                    <p class="movie__option"><a href="/menuLeft.php">Sci-Fi</a> | <a href="/menuLeft.php">Thriller</a> | <a href="/menuLeft.php">Drama</a></p>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--left">
                                <div class="movie__<?php echo Yii::app()->request->baseUrl; ?>/images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-time1.jpg">
                                    </a>
                                </div>
                                ...
                                <div class="movie__info">
                                    ...
                                    <p class="movie__option"><a href="/menuLeft.php">Adventure</a> | <a href="/menuLeft.php">Fantasy</a> | <a href="/menuLeft.php">Drama</a></p>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--right">
                                <div class="movie__<?php echo Yii::app()->request->baseUrl; ?>/images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-time9.jpg4">
                                    </a>
                                </div>
                                ...
                                <div class="movie__info">
                                    ...
                                    <p class="movie__option"><a href="/menuLeft.php">Action</a> | <a href="/menuLeft.php">Adventure</a> | <a href="/menuLeft.php">Sci-Fi</a></p>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--right">
                                <div class="movie__<?php echo Yii::app()->request->baseUrl; ?>/images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-time10.jpg">
                                    </a>
                                </div>
                                ...
                                <div class="movie__info">
                                    ...
                                    <p class="movie__option"><a href="/menuLeft.php">Action</a> | <a href="/menuLeft.php">Adventure</a> | <a href="/menuLeft.php">Fantasy</a></p>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--left">
                                <div class="movie__<?php echo Yii::app()->request->baseUrl; ?>/images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-time11.jpg">
                                    </a>
                                </div>
                                ...
                                <div class="movie__info">
                                    ...
                                    <p class="movie__option"><a href="/menuLeft.php">Action</a> | <a href="/menuLeft.php">Adventure</a> | <a href="/menuLeft.php">Horror</a></p>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--left">
                                <div class="movie__<?php echo Yii::app()->request->baseUrl; ?>/images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-time12.jpg">
                                    </a>
                                </div>
                                ...
                                <div class="movie__info">
                                    ...
                                    <p class="movie__option"><a href="/menuLeft.php">Crime</a> | <a href="/menuLeft.php">Thriller</a> | <a href="/menuLeft.php">Drama</a></p>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--right">
                                <div class="movie__<?php echo Yii::app()->request->baseUrl; ?>/images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-time13.jpg">
                                    </a>
                                </div>
                                ...
                                <div class="movie__info">
                                    ...
                                    <p class="movie__option"><a href="/menuLeft.php">Comedy</a> | <a href="/menuLeft.php">Fantasy</a></p>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--right">
                                <div class="movie__<?php echo Yii::app()->request->baseUrl; ?>/images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/movie/movie-time14.jpg">
                                    </a>
                                </div>
                                ...
                                <div class="movie__info">
                                    ...
                                    <p class="movie__option"><a href="/menuLeft.php">Comedy</a></p>
