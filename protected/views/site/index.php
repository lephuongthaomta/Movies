...
<div class="movie-beta__item ">
    <img alt='' src="<?php echo Yii::app()->request->baseUrl.$value->anhDaiDien; ?>">
        ...
        <ul class="movie-beta__info">
            <a href='' class="movie__title"><b><?php echo $value->tenPhim?></b> </a>
            <p class="movie__option"><a href="">Loại phim: <?php echo $value->dinhDang?></a></p>
            <p class="movie__time">Thời lượng:<?php echo $value->thoiLuong?></p>                                   
            <p class="movie__option"><a href="">Diễn viên: <?php echo $value->dienVienChinh?></a> </p>
            <p class="movie__option"><a href="">Đạo diễn: <?php echo $value->daoDien?></a></p>
            <p class="movie__option"><a href="">Khởi chiếu: <?php echo $value->khoiChieu?></a></p>
            <li class="last-block">
                <a href="<?php echo Yii::app()->request->baseUrl.'/chitietphim/chitietphim/id/';?><?php echo $value->id_phim?>" class="slide__link">more </a>
            </li>
        </ul>
</div>
<?php
                    ...
                    <aside class="col-sm-4 col-md-3">
                        <div class="sitebar first-banner--left">
                            ...
                            <div class="promo marginb-sm">
                              <div class="promo__head">Movie app</div>
