   ...
   <section class="container">
            <div class="overflow-wrapper">
                <h2 class="page-heading heading--outcontainer">Tin tức</h2>
                ...
                <!-- News post article-->
                    <article class="post post--news">
                        <a href='#' class="post__image-link">
                            <img alt='' src="<?php echo Yii::app()->request->baseUrl; ?>/images/new/dangcapthucung.jpg">
                        </a>

                        <h1><a href="#" class="post__title-link">Mua một tặng một thú cưng</a></h1>
                        <p class="post__date">29 October 2013 </p>

                        <div class="wave-devider">Mua 1 tặng 1 siêu phẩm "Đẳng cấp thú cưng"</br>
                            Từ 29/7, Trung tâm Chiếu phim Quốc gia sẽ áp dụng MUA 1 TẶNG 1 với siêu phẩm hoạt hình ĐẲNG CẤP THÚ CƯNG. </br>
                                Lưu ý: Chỉ áp dụng khi mua vé offline.</br>
                            Bạn nào chưa xem - xem ngay kẻo lỡ nào !!!</div>
